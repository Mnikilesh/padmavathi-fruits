...
const JWT_SECRET         = process.env.JWT_SECRET         || 'pfcSecret_change_in_prod_2024_xyz';
const JWT_REFRESH_SECRET = process.env.JWT_REFRESH_SECRET || 'pfcRefresh_change_in_prod_2024_abc';
